...
| Email identity (work/personal) | data/db/aika.sqlite (assistant profile) | Settings -> Connections | /api/assistant/profile |
| Assistant profile | data/db/aika.sqlite | Settings -> Connections/Voice/Appearance | /api/assistant/profile |
